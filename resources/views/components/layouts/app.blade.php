...
<body class="g-sidenav-show bg-gray-100">
  ...
  <script>
    // Add this to your layout or component view
    document.addEventListener('DOMContentLoaded', function() {
      // Check for updates every 5 minutes
      setInterval(function() {
        Livewire.dispatch('checkAndUpdateDepreciation');
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      var scrollElement = document.querySelector('#sidenav-scrollbar');
      ...
      if (win && scrollElement) {
        ...
        try {
          ...
          console.error("Error initializing scrollbar:", err);
        }
      }
    });
  </script>
