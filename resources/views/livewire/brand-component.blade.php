                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a href="javascript:;" wire:click="edit({{ $data->id_merk }})" class="text-warning font-weight-bold text-xs me-3" data-bs-toggle="modal" data-bs-target="#editPage">Edit</a>
                                            <a href="javascript:;" wire:click="confirm({{ $data->id_merk }})" class="text-danger font-weight-bold text-xs" data-bs-toggle="modal" data-bs-target="#deletePage">Delete</a>
                                        </td>
                                    </tr>
                                    @endforeach
                                    @endif
                        ...
                        <div class="modal-body">
                            <form>
                                <div class="from-group">
                                    <label>Brand</label>
                                    <input type="text" class="form-control" wire:model="merk" value="{{ @old('merk')}}">
                                    @error('merk')
